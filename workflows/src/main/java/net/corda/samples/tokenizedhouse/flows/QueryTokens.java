...
public class QueryTokens {
    ...
    public static class GetTokenBalance extends FlowLogic<String> {
        ...
        public String call() throws FlowException {
            ...
            Set<FungibleVaccineTokenState> evolvableTokenTypeSet = getServiceHub().getVaultService().
            ...
            for (FungibleVaccineTokenState evolvableTokenType : evolvableTokenTypeSet){
                //get the pointer pointer to the house
                TokenPointer<FungibleVaccineTokenState> tokenPointer = evolvableTokenType.toPointer(FungibleVaccineTokenState.class);
